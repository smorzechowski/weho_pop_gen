...
names <- read.table('~/PhD research/Neo sex chromosome/WEHE pop gen chapter/WEHE pop gen/LEA/vcf_sample_names_43males.txt',header=F)
...
# Define file name
output_file <- "inversion_dummy_midpoint_males.vcf"
