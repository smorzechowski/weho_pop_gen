...
setwd("~/PhD research/Neo sex chromosome/WEHE pop gen chapter/WEHE assembly/findZX/Nesoptilotis_hap1")
...
lengths <- read.table("coverage/nleucotis_yamma_366917_f.hap1.p_ctg.filter.10000.fasta.fai",header=F,sep="\t",comment.char="")
...
coverage_neoZ$contig <- str_remove_all(coverage_neoZ$V1,"nleucotis_yamma_366917_f.hap1#pri#")
...
coverage_neoW$contig <- str_remove_all(coverage_neoW$V1,"nleucotis_yamma_366917_f.hap1#pri#")
